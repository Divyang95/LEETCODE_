...
const SubmissionList = ({submissions, isLoading}) => {
    ...
    //to converte stringified data into object 
    ...
    if(!submissions?.length){
        return(
            <div className='text-center p-8'>
                <div className='text-base-content/70'>No Submission YET</div>
            </div>
        )
    }
    ...
    <div className='space-y-4'> 
      {
        submissions.map((submission)=>{
            console.log("I am inside Submission List submission memory",submission.memory)
